...
import {
  BsCameraVideo, BsFillHouseFill, BsHandIndex,
  BsPersonFill, BsPuzzleFill, BsShopWindow,
} from 'react-icons/bs';
...
export default function TariffsTabletAndMobile({ isOn, getDisplayPrice, tariffs }: TariffsTabletProps) {
  return (
